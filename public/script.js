...
// أسئلة المسابقات - 100 سؤال باللغة العربية
const QUIZ_QUESTIONS = [
    ...
    // أسئلة عن التاريخ
    {
        ...
        options: ["جورج واشنطن", "توماس جيفرسون", "أبراهام لنكولن", "فرانكلين روزفلت"],
        correct: 0
    },
    {
    ...
    },
    {
        ...
        options: ["1939-1945", "1914-1918", "1945-1950", "1930-1935"],
        correct: 0
    },
    {
        question: "من هو مكتشف أمريكا؟",
        options: ["كريستوفر كولومبوس", "ماركو بولو", "فاسكو دا غاما", "ماجلان"],
        correct: 0
    },
    {
        question: "في أي عام وقعت معركة حطين؟",
        options: ["1187", "1188", "1186", "1185"],
        correct: 0
    },
    {
        question: "من هو آخر ملوك الرومان؟",
        options: ["تراجان", "هادريان", "ماركوس أوريليوس", "رومولوس أوغسطولوس"],
        correct: 3
    },
    {
        question: "ما هي أول حضارة في مصر؟",
        options: ["الدولة القديمة", "الدولة الوسطى", "الدولة الحديثة", "العصر البرونزي"],
        correct: 0
    },
    {
        question: "من هو مؤسس الإمبراطورية الفارسية الأخمينية؟",
        options: ["داريوس", "كورش الكبير", "زركسيس", "أرتحشستا"],
        correct: 1
    },
    {
        question: "في أي عام تم توحيد ألمانيا؟",
        options: ["1871", "1872", "1870", "1873"],
        correct: 0
    },
    ...
    // أسئلة عن الأدب
    {
        ...
        options: ["أبو حيان التوحيدي", "شهروزاد", "ابن خلدون", "الجاحظ"],
        correct: 1
    },
    {
        question: "ما هو أشهر مسرحية لشكسبير؟",
        options: ["روميو وجولييت", "هاملت", "ماكبث", "عطيل"],
        correct: 1
    },
    {
        question: "من هو شاعر المتنبي؟",
        options: ["أبو الطيب المتنبي", "أبو تمام", "البحتري", "جرير"],
        correct: 0
    },
    {
        question: "ما هي أول رواية في الأدب العربي؟",
        options: ["زينب", "أمامة", "الأيام", "حديث عم حسن"],
        correct: 0
    },
    {
        question: "من هو مؤلف كتاب الشعر والشعراء؟",
        options: ["ابن قتيبة", "ابن رشيق", "الجرجاني", "الآمدي"],
        correct: 0
    },
    {
        question: "ما هي أشهر قصيدة للمتنبي؟",
        options: ["خلت الديار بيوتاً من الديار", "وفي كلّ يدٍ للفتى ما يُدهشُ", "أَنا الذي نَظَرَ الأَعمى إِلَى أَدَبِي", "كفى بك داءً أَنَّكَ ضِيَعْتَ مَرْضًا"],
        correct: 2
    },
    {
        question: "من هو شاعر الجاهلية الشهير؟",
        options: ["امرؤ القيس", "زهير بن أبي سلمى", "لبيد بن ربيعة", "كل الإجابات صحيحة"],
        correct: 3
    },
    {
        question: "ما هي أول جريدة في العالم العربي؟",
        options: ["الوقائع المصرية", "الأهرام", "الشرق الأوسط", "الجزيرة"],
        correct: 0
    },
    {
        question: "من هو مؤلف كتاب المعجم الوسيط؟",
        options: ["مجمع اللغة العربية", "ابن منظور", "الفيروزآبادي", "الزبيدي"],
        correct: 0
    },
    {
        question: "ما هي أشهر قصة في ألف ليلة وليلة؟",
        options: ["علاء الدين والمصباح السحري", "سندباد البحري", "علي بابا والأربعون حرامي", "كل الإجابات صحيحة"],
        correct: 3
    },

    // أسئلة عن الرياضة
    {
        question: "من هو أفضل لاعب كرة قدم في التاريخ؟",
        options: ["ليونيل ميسي", "كريستيانو رونالدو", "بيليه", "مارادونا"],
        correct: 3
    },
    {
        question: "في أي مدينة أُقيمت أول أولمبياد حديثة؟",
    ...
    {
        question: "ما هو الرياضة التي تُلعب على الجليد؟",
        options: ["الهوكي", "الكرلينج", "التزلج", "كل الإجابات صحيحة"],
        correct: 3
    },
    {
        question: "من هو بطل العالم في الملاكمة؟",
        options: ["مايك تايسون", "محمد علي كلاي", "جو فريزر", "كل الإجابات صحيحة"],
        correct: 3
    },
    {
        question: "ما هي سرعة الكرة في التنس؟",
        options: ["100 كم/س", "200 كم/س", "300 كم/س", "400 كم/س"],
        correct: 1
    },
    {
        question: "في أي رياضة يُستخدم المضرب؟",
        options: ["التنس", "البادمينتون", "السكواش", "كل الإجابات صحيحة"],
        correct: 3
    },
    {
        question: "من هو أسرع رجل في العالم؟",
        options: ["أوسين بولت", "كريستوف ليمتر", "مايكل جونسون", "كارل لويس"],
        correct: 0
    },
    {
        question: "ما هي رياضة السباحة؟",
        options: ["فردي", "جماعي", "فردي وجماعي", "لا شيء مما سبق"],
        correct: 2
    },
    {
        question: "كم عدد الدورات في سباق المضمار؟",
        options: ["100م", "200م", "400م", "كل الإجابات صحيحة"],
        correct: 3
    },

    // أسئلة عن التكنولوجيا
    {
    ...
    // أسئلة عن الطبيعة
    {
        ...
        options: ["إفرست", "ك2", "كانتشنجونجا", "ماناسلو"],
        correct: 0
    },
    {
        question: "كم عدد أنواع الطيور في العالم؟",
        options: ["5,000", "10,000", "15,000", "أكثر من 10,000"],
        correct: 3
    },
    {
    ...
    {
        question: "كم عمر الديناصورات؟",
        options: ["65 مليون سنة", "100 مليون سنة", "150 مليون سنة", "200 مليون سنة"],
        correct: 0
    },
    {
    ...
    {
        question: "كم عدد أنواع الأسماك؟",
        options: ["10,000", "20,000", "30,000", "أكثر من 30,000"],
        correct: 3
    },
    {
        question: "ما هي أكبر زهرة في العالم؟",
        options: ["الورد", "الزنبق", "رافليزيا", "هيليكونيا"],
        correct: 2
    },
    {
        question: "كم ارتفاع شجرة السكويا؟",
        options: ["50 متر", "100 متر", "150 متر", "200 متر"],
        correct: 1
    },
    {
    ...
    {
        question: "كم عدد الجزر في إندونيسيا؟",
        options: ["5,000", "10,000", "15,000", "أكثر من 17,000"],
        correct: 3
    },

    // أسئلة عن الثقافة العربية
    {
        question: "ما هي الآلة الموسيقية العربية الشهيرة؟",
        options: ["العود", "القانون", "الناي", "كل الإجابات صحيحة"],
        correct: 3
    },
    {
        question: "من هو أشهر مطرب عربي؟",
        options: ["أم كلثوم", "عبد الحليم حافظ", "فيروز", "كل الإجابات صحيحة"],
        correct: 3
    },
    {
        question: "ما هي الرقصة الشعبية المصرية؟",
        options: ["الدبكة", "السامري", "العيالة", "الطبلة"],
        correct: 1
    },
    {
        question: "من هو أشهر شاعر نبطي؟",
        options: ["محمد بن لعبون", "راشد الزلامي", "خلف بن هذال", "عبدالله الحامد"],
        correct: 0
    },
    {
        question: "ما هي أشهر الأكلة المصرية؟",
        options: ["الكشري", "الفلافل", "الفول", "كل الإجابات صحيحة"],
        correct: 3
    },
    {
        question: "من هو أشهر رسام عربي؟",
        options: ["محمود سعيد", "جبرا إبراهيم جبرا", "شاكر علي", "كل الإجابات صحيحة"],
        correct: 3
    },
    {
        question: "ما هي أشهر الأغنية الشعبية الخليجية؟",
        options: ["السامري", "العرضة", "الخبيتي", "كل الإجابات صحيحة"],
        correct: 3
    },
    {
        question: "من هو أشهر ممثل مصري؟",
        options: ["عادل إمام", "أحمد زكي", "نور الشريف", "كل الإجابات صحيحة"],
        correct: 3
    },
    {
        question: "ما هي أشهر القصص الشعبية العربية؟",
        options: ["قصص عنترة", "قصص بُحَيْرَة", "قصص السندباد", "كل الإجابة صحيحة"],
        correct: 3
    },
    {
        question: "من هو أشهر عالم فلك عربي؟",
        options: ["البيروني", "البتّاني", "ابن الهيثم", "كل الإجابات صحيحة"],
        correct: 3
    },
    ...
    // أسئلة عن الفنون
    {
        ...
        options: ["الموناليزا", "ليلة النجوم", "الصراخ", "الفتاة ذات اللؤلؤة"],
        correct: 0
    },
    {
        question: "من هو أشهر نحّات؟",
        options: ["ميخائيل أنجلو", "رودان", "برنيني", "دوناتيلو"],
        correct: 0
    },
    {
        question: "ما هي أشهر الأوبرا؟",
        options: ["لا ترافياتا", "كارمن", "مادام بترفلي", "كل الإجابات صحيحة"],
        correct: 3
    },
    {
        question: "من هو أشهر مصمم أزياء؟",
        options: ["كوكو شانيل", "إيف سان لوران", "ديور", "كل الإجابات صحيحة"],
        correct: 3
    },
    {
        question: "ما هي أشهر الباليه؟",
        options: ["بحيرة البجع", "الجمال النائم", "الجوزاء", "كل الإجابات صحيحة"],
        correct: 3
    },
    {
        question: "من هو أشهر عازف بيانو؟",
        options: ["لودفيغ فان بيتهوفن", "فريدريك شوبان", "ولاديمير هوروفيتز", "كل الإجابات صحيحة"],
        correct: 3
    },
    {
        question: "ما هي أشهر الموسيقى الكلاسيكية؟",
        options: ["السمفونية التاسعة", "الكونشيرتو للبيانو", "الكوارتيت", "كل الإجابات صحيحة"],
        correct: 3
    },
    {
        question: "من هو أشهر مخرج سينمائي؟",
        options: ["ألفريد هيتشكوك", "ستانلي كوبريك", "مارتن سكورسيزي", "كل الإجابات صحيحة"],
        correct: 3
    },
    {
        question: "ما هي أشهر رقصة في العالم؟",
        options: ["التانغو", "السامبا", "الوالتز", "كل الإجابات صحيحة"],
        correct: 3
    },
    {
        question: "من هو أشهر صانع مجوهرات؟",
        options: ["كارتييه", "تيفاني", "بوليسي", "كل الإجابات صحيحة"],
        correct: 3
    },
    ...
    },
    {
        ...
        options: ["السومرية", "المصرية", "الصينية", "اليونانية"],
        correct: 0
    },
    {
        question: "من هو أكثر إنساناً مشهوراً في التاريخ؟",
        options: ["محمد صلى الله عليه وسلم", "يسوع المسيح", "نابليون", "هتلر"],
        correct: 0
    },
    {
        question: "ما هي أغلى مادة في العالم؟",
        options: ["الذهب", "الماس", "الأنتيماتير", "الراديوم"],
        correct: 2
    },
    {
        question: "كم عدد اللغات في العالم؟",
        options: ["3,000", "6,000", "7,000", "أكثر من 7,000"],
        correct: 3
    },
    {
        question: "ما هي أكثر دولة زراعة في العالم؟",
        options: ["الصين", "الهند", "البرازيل", "الولايات المتحدة"],
        correct: 1
    },
    {
        question: "من هو أكثر ملك حكماً في التاريخ؟",
        options: ["لويس الرابع عشر", "الملكة فيكتوريا", "الإمبراطور تشين شي هوانغ", "السلطان محمد الفاتح"],
        correct: 0
    },
    {
        question: "ما هي أكبر مدينة في العالم؟",
        options: ["طوكيو", "نيويورك", "لندن", "باريس"],
        correct: 0
    },
    {
        question: "كم عدد الأشخاص الذين عاشوا في التاريخ؟",
        options: ["50 مليار", "100 مليار", "150 مليار", "200 مليار"],
        correct: 0
    }
];

// تصدير المصفوفة لاستخدامها في الكود
